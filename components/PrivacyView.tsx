  ...
  return (
    <div className="flex flex-col h-full gap-6 pb-20">
      ...
      <div className="flex-1 flex flex-col lg:flex-row gap-6 min-h-0">
        ...
        {/* Right: Editor / Result */}
        <div className="flex-1 bg-surface-dark border border-border-dark rounded-xl flex flex-col shadow-2xl overflow-hidden">
            ...
            <div className="flex-1 relative">
                <textarea 
                    ...
                    placeholder={isGenerating ? "AI is reviewing your manifest..." : "Policy will appear here..."}
                    className="w-full h-full bg-surface-darker p-6 text-sm font-mono text-gray-300 focus:outline-none resize-none"
                    spellCheck={false}
                />
            </div>
        </div>
